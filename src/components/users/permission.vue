  ...
  <el-card class="box-card">
    ...
    <el-dialog title="添加" :visible.sync="dialogFormVisibleAdd" width="30%" center  top="20">
      <el-form :model="form" :rules="rules" ref="form" status-icon>
        <el-form-item label="权限名" :label-width="formLabelWidth" prop="permissionName">
          <el-input v-model="form.permissionName" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="权限码" :label-width="formLabelWidth" prop="permissionCode">
          <el-input v-model="form.permissionCode" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="权限URL" :label-width="formLabelWidth" prop="permissionUrl">
